...
VALUES ('Sofi Oksanen',  'When the Doves Disappeared', 35, 
        ...
        'Communist Estonia, 1941. As the Allies and the Axis clash in battle...', 
...
VALUES ('Nora Barrett',  'The King of Drugs', 15, 
        ...
        'The story of notorious drug kingpin Pablo Escobar, who became....', 
...
VALUES ('Kelly McWilliams',  'Agnes at the End of the World', 25, 
        ...
        'The Handmaids Tale meets Wilder Girls in this genre-defying novel...', 
...
-- INSERT INTO books ( author, name, cost, cover_image, description, isbn, create_at, update_at)
-- VALUES ('Charles Dickens',  'A Tale of Two Cities', 25, 
--         'https://drive.google.com/file/d/1pbaT5c_-UnuPdpkBIPwaYg8W5-EokLDc/view', 
--         'The novel tells the story of the French Doctor Manette, 
...
-- INSERT INTO books ( author, name, cost, cover_image, description, isbn, create_at, update_at)
-- VALUES ('Andy Weir',  'The Martian', 30, 
--         'https://drive.google.com/file/d/1r3o3ILJhqhz-E-c5Fya-3qOffyApZSfH/view', 
--         'The story follows an American astronaut, Mark Watney, 
...
-- INSERT INTO books ( author, name, cost, cover_image, description, isbn, create_at, update_at)
-- VALUES ('Sofi Oksanen',  'When the Doves Disappeared', 35, 
--         'https://drive.google.com/file/d/1k1-lZHFvjxWcoayuIt55RjbtfKRISZM-/view', 
...
-- INSERT INTO books ( author, name, cost, cover_image, description, isbn, create_at, update_at)
-- VALUES ('Nora Barrett',  'The King of Drugs', 15, 
--         'https://drive.google.com/file/d/1wTA8XG9e0A8M4fveCLktsACJB0IFHl-C/view', 
...
-- INSERT INTO books ( author, name, cost, cover_image, description, isbn, create_at, update_at)
-- VALUES ('Kelly McWilliams',  'Agnes at the End of the World', 25, 
--         'https://drive.google.com/file/d/1yRPLL4zmK4rHYy5UZXs7gu0Vkd3H30wX/view', 
